    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medications', models.ManyToManyField(blank=True, related_name='users_medications', to='users.medication')),
                ('nutritions', models.ManyToManyField(blank=True, related_name='users_nutritions', to='users.nutrition')),
