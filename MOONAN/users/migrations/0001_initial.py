...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nutrition_name', models.CharField(choices=[('probiotics', '유산균'), ('omega3', '오메가3'), ('lutein', '루테인'), ('multivitamin', '종합비타민'), ('vitaminC', '비타민C'), ('vitaminD', '비타민D'), ('vitaminA', '비타민A'), ('collagen', '콜라겐'), ('iron', '철분'), ('propolis', '프로폴리스'), ('aronia', '아로니아'), ('folic_acid', '엽산'), ('magnesium', '마그네슘'), ('vitaminE', '비타민E'), ('calcium', '칼슘'), ('add', '직접 입력')], max_length=100, verbose_name='복용 중인 영양제')),
            ],
        ),
        migrations.CreateModel(
            name='UserNutrition',
        ...
        migrations.AddField(
            model_name='user',
            name='medications',
            field=models.ManyToManyField(blank=True, related_name='users_medications', through='users.UserMedication', to='users.medication'),
        ),
        migrations.AddField(
            model_name='user',
            name='nutritions',
            field=models.ManyToManyField(blank=True, related_name='users_nutritions', through='users.UserNutrition', to='users.nutrition'),
        ),
        migrations.AddField(
            model_name='user',
