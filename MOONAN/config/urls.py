...
from config.views import (home_view, accept_connection_request, reject_connection_request, alarm_view, locker_view,
                          daily_status, reset_daily_status, get_selectDay)
...
urlpatterns = [
    ...
    path('home/message/', include('message.urls', namespace='message')),
