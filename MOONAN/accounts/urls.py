...
from .views import (join_view, id_check, login_view, send_connection_request, birth_info_view, drug_info_view,
...
urlpatterns = [
    ...
    path('accountConnectDetailDrug/', drug_info_view, name='drug_info'),
